...
<head>
	...
	<title>Candidatez à nos concours</title>
	...
	<div class="container-fluid">
		<div class="col-12">
			<div class="mybreadcrumb flat">
				...
				<a href="#" class="active">Entreprendre</a>
				<a href="#">Candidatez à nos concours</a>
			</div>
		</div> <!-- col-12 -->
	</div> <!-- row -->
</div> <!-- container -->
...
<div class="container-fluid">
	<div class="row text-center">
		...
		<div class="col-xl-9 col-md-9 col-xs-12 col-9-pad mr-auto" >
			<h1 class="titreh1 text-center">Candidatez à nos concours</h1>
